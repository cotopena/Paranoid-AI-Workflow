...
- Consult `workflow/tooling.config.json` for key paths (`../your-product-repo/src/app`, `../your-product-repo/src/engine`, `../your-product-repo/convex`, `.documents/.plans/...`, `.documents/research/...`, `.documents/prs/...`).
...
- inspect env/config usage in `../your-product-repo/next.config.ts`, `../your-product-repo/proxy.ts`, `../your-product-repo/.env.example`, or related files
