...
- Skip Web tooling whenever `network_access` is restricted and lean on the code roots enumerated in the config (`../your-product-repo/src/app`, `../your-product-repo/convex/`, `../your-product-repo/public/`, etc.).
