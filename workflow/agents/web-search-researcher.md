...
description: Performs external research for Project. Use when you need current guidance on Next.js, Convex, Clerk, Stripe, OpenAI, or financial-modeling implementation patterns.
...
- Use `workflow/tooling.config.json` to confirm local mirrors (`../your-product-repo/src/app`, `../your-product-repo/src/engine`, `../your-product-repo/convex/`, `.documents/research/`) when cross-referencing files.
